...
public class Demo {
    ...
    public static void main(String[] args) throws Exception{
        ...
        CombinedSystem system1 = new CombinedSystem(controller1,heartBeatManager1,adjNodes1);
        new Thread(system1).start();

        Controller controller2 = new Controller(0,8001,8001,"localhost");
        HeartBeatManager heartBeatManager2 = new HeartBeatManager("localhost",1,8001);
        CombinedSystem system2 = new CombinedSystem(controller2,heartBeatManager2,adjNodes2);
        new Thread(system2).start();

        Controller controller3 = new Controller(0,8002,8002,"localhost");
        HeartBeatManager heartBeatManager3 = new HeartBeatManager("localhost",2,8002);
        CombinedSystem system3 = new CombinedSystem(controller3,heartBeatManager3,adjNodes3);
